...
const CATEGORIAS = {
  ...
  frios: {
    ...
    corBg: "#fef9f0",
    unidade: "gramas",
    itens: [{ id: "apresuntado", nome: "Apresuntado", preco: 1.52, porcao: "60g" , vendaPorKg: true, kgBase: 0.06 },{ id: "bisnaga-catupiry", nome: "Catupiry", preco: 47.96, porcao: "1,5kg", vendaPorKg: true, kgBase: 1.5 },{ id: "bisnaga-cheddar", nome: "Cheddar", preco: 13.5, porcao: "1,2kg" },{ id: "mussarela", nome: "Mussarela", preco: 2.87, porcao: "60g" , vendaPorKg: true, kgBase: 0.06 },{ id: "provolone", nome: "Provolone", preco: 1.60, porcao: "30g" },{ id: "queijo-fresco", nome: "Queijo Fresco", preco: 4.3, porcao: "100g" },{ id: "queijo-prato", nome: "Queijo Prato", preco: 1.26, porcao: "30g" },{ id: "salsicha", nome: "Salsicha", preco: 1.0, porcao: "unidade" },
    ]
  },
  vegetais: {
    nome: "🥦 Vegetais",
    ...
    corBg: "#f2fdf5",
    unidade: "gramas",
    itens: [{ id: "azeitona", nome: "Balde de Azeitona", preco: 55.00, porcao: "balde" },{ id: "brocolis", nome: "Brócolis", preco: 4.79, porcao: "70g" },{ id: "ervilha", nome: "Ervilha", preco: 0.75, porcao: "un" },{ id: "escarola", nome: "Escarola", preco: 3.42, porcao: "70g" },{ id: "laka", nome: "Laka", preco: 6.06, porcao: "100g" },{ id: "maionese", nome: "Maionese", preco: 13.50, porcao: "1kg" },{ id: "milho-mistura", nome: "Milho Mistura", preco: 0.71, porcao: "40g" },{ id: "milho-puro", nome: "Milho Puro", preco: 1.65, porcao: "80g" },{ id: "molho-alho", nome: "Molho Alho", preco: 13.20, porcao: "un" },{ id: "morango", nome: "Morango", preco: 11.00, porcao: "100g" },{ id: "oregano", nome: "Orégano", preco: 14.60, porcao: "500g" },{ id: "pimenta", nome: "Pimenta", preco: 13.49, porcao: "un" },{ id: "tomate-seco", nome: "Tomate Seco", preco: 53.66, porcao: "4kg" },
    ]
  },
  massas: {
    nome: "🥔 Massas",
    ...
    corBg: "#faf2fe",
    unidade: "pacote",
    itens: [{ id: "batata-congelada-625", nome: "Batata Frita G", preco: 8.25, porcao: "650g" },{ id: "batata-congelada-350", nome: "Batata Frita P", preco: 4.62, porcao: "325g" },{ id: "batata-palha", nome: "Batata Palha", preco: 28.05, porcao: "800g" , vendaPorKg: true, kgBase: 0.8 },{ id: "massa-pastel", nome: "Massa de Pastel", preco: 47.00, porcao: "pacote 5kg", vendaPorKg: true, kgBase: 5.0 },{ id: "pure", nome: "Purê", preco: 15.50, porcao: "kg", vendaPorKg: true, kgBase: 1.0 },{ id: "saco-pao-hot-dog", nome: "Pão Hot Dog", preco: 13.50, porcao: "10 unid." },{ id: "oleo", nome: "Óleo", preco: 7.57, porcao: "un" },
    ]
  },
  doces: {
    nome: "🍯 Doces",
    ...
    corBg: "#fef5ec",
    unidade: "unidade",
    itens: [{ id: "ameixa", nome: "Ameixa", preco: 3.57, porcao: "50g" },{ id: "acucar", nome: "Açúcar", preco: 5.20, porcao: "kg" },{ id: "beijinho", nome: "Beijinho", preco: 39.06, porcao: "1kg" },{ id: "canela", nome: "Canela", preco: 22.0, porcao: "500g" },{ id: "cereja", nome: "Cereja", preco: 7.8, porcao: "50g" },{ id: "chocolate-leite", nome: "Chocolate ao Leite", preco: 44.0, porcao: "1kg" , vendaPorKg: true, kgBase: 1.0 },{ id: "chocolate-branco", nome: "Chocolate Branco", preco: 39.0, porcao: "1kg" , vendaPorKg: true, kgBase: 1.0 },{ id: "chocolate-cremoso", nome: "Chocolate Cremoso Gourmet", preco: 45.00, porcao: "kg", vendaPorKg: true, kgBase: 1.0 },{ id: "coco", nome: "Coco Ralado", preco: 49.0, porcao: "1kg", pesoCustom: true , vendaPorKg: true, kgBase: 1.0 },{ id: "doce-leite", nome: "Doce de Leite", preco: 135.0, porcao: "balde 4,8kg" , vendaPorKg: true, kgBase: 4.8 },{ id: "goiabada", nome: "Goiabada", preco: 1.30, porcao: "100g" },{ id: "granulado", nome: "Granulado", preco: 31.70, porcao: "100g" },{ id: "leite-condensado", nome: "Leite Condensado", preco: 8.50, porcao: "395g" },{ id: "suflair", nome: "Suflair", preco: 9.1, porcao: "50g" },
    ]
  },
  salgados: {
    nome: "🥧 Salgados",
    ...
    corBg: "#fdf0ef",
    unidade: "unidade",
    itens: [{ id: "coxinha-frango", nome: "Coxinha Frango", preco: 7.50, porcao: "un" },{ id: "coxinha-frango-catupiry", nome: "Coxinha Frango c/ Catupiry", preco: 7.50, porcao: "un" },{ id: "empada-palmito", nome: "Empada de Palmito", preco: 7.50, porcao: "un" },{ id: "empada-frango-catupiry", nome: "Empada Frango c/ Catupiry", preco: 7.50, porcao: "un" },{ id: "esfiha-calabresa-catupiry", nome: "Esfiha Calabresa Catupiry", preco: 7.50, porcao: "un" },{ id: "esfiha-carne", nome: "Esfiha de Carne", preco: 7.50, porcao: "un" },{ id: "esfiha-frango-catupiry", nome: "Esfiha Frango Catupiry", preco: 7.50, porcao: "un" },{ id: "kibe", nome: "Kibe", preco: 7.50, porcao: "un" },{ id: "kibe-catupiry", nome: "Kibe c/ Catupiry", preco: 7.50, porcao: "un" },{ id: "kibe-mussarela", nome: "Kibe c/ Mussarela", preco: 7.50, porcao: "un" },
    ]
  },
  embalagens: {
    nome: "📦 Embalagens",
    ...
    corBg: "#f0f7ff",
    unidade: "unidade",
    itens: [{ id: "bandeja-batata-g", nome: "Bandeja Batata G", preco: 49.90, porcao: "c/100 unid." },{ id: "bandeja-batata-p", nome: "Bandeja Batata P", preco: 0.25, porcao: "unidade" },{ id: "bobinas-impressora", nome: "Bobinas", preco: 15.84, porcao: "3 unid." },{ id: "bombril", nome: "Bombril", preco: 2.80, porcao: "un" },{ id: "caixa-grande", nome: "Caixa Grande", preco: 2.46, porcao: "un" },{ id: "caixa-media", nome: "Caixa Média", preco: 2.09, porcao: "un" },{ id: "copo-180", nome: "Copo 180ml", preco: 4.18, porcao: "pct" },{ id: "copo-300", nome: "Copo 300ml", preco: 7.81, porcao: "pct" },{ id: "detergente", nome: "Detergente", preco: 2.90, porcao: "un" },{ id: "durex", nome: "Durex", preco: 20.9, porcao: "5 unid." },{ id: "embalagem-lanche", nome: "Embalagem de Lanche", preco: 30.25, porcao: "un" },{ id: "embalagem-empada-50", nome: "Embalagem Empada", preco: 59.00, porcao: "c/50 unid." },{ id: "embalagem-empada-g", nome: "Embalagem Empada G", preco: 0.19, porcao: "unidade" },{ id: "embalagem-empada-p", nome: "Embalagem Empada P", preco: 0.15, porcao: "unidade" },{ id: "bandeja-bh-101", nome: "Estojo 101", preco: 52.41, porcao: "cx c/100" },{ id: "bandeja-bh-102", nome: "Estojo 102", preco: 135.50, porcao: "cx c/100" },{ id: "interfolha", nome: "Interfolha", preco: 12.76, porcao: "1 pct" },{ id: "luva-borracha", nome: "Luva Borracha", preco: 5.60, porcao: "par" },{ id: "luva-descartavel", nome: "Luva Descartável", preco: 2.20, porcao: "cx" },{ id: "touca-descartavel", nome: "Pacote Touca Descartável", preco: 16.50, porcao: "pct" },{ id: "papel-toalha", nome: "Papel Toalha", preco: 6.20, porcao: "rolo" },{ id: "papel-tv", nome: "Papel TV", preco: 10.23, porcao: "un" },{ id: "ketchup-heinz", nome: "Sachê Ketchup Heinz", preco: 25.30, porcao: "cx unidade" },{ id: "maionese-heinz", nome: "Sachê Maionese Heinz", preco: 25.30, porcao: "cx unidade" },{ id: "mostarda-heinz", nome: "Sachê Mostarda Heinz", preco: 25.30, porcao: "cx unidade" },{ id: "saco-canudo", nome: "Saco de Canudo", preco: 12.10, porcao: "un" },{ id: "saco-lixo", nome: "Saco de Lixo", preco: 13.46, porcao: "un" },{ id: "saco-lixo-60l", nome: "Saco de Lixo 60L", preco: 13.46, porcao: "un" },{ id: "saco-grecepell-1kg", nome: "Saco Grecepell 1kg", preco: 55.00, porcao: "500 unidades" },{ id: "saco-grecepell-2kg", nome: "Saco Grecepell 2kg", preco: 74.25, porcao: "500 unidades" },{ id: "saco-hot-dog", nome: "Saco Hot Dog", preco: 11.0, porcao: "500 unid." },{ id: "sacola-25x35", nome: "Sacola 25x35", preco: 4.18, porcao: "100 unid." },{ id: "sacola-35x45", nome: "Sacola 35x45", preco: 8.25, porcao: "100 unid." },{ id: "toalha-americana", nome: "Toalha Americana", preco: 26.18, porcao: "1 pacote" },{ id: "toca-descartavel", nome: "Toca Descartável", preco: 16.50, porcao: "1 pacote" },{ id: "viagem", nome: "Viagem", preco: 6.60, porcao: "un" },
    ]
  }
}
