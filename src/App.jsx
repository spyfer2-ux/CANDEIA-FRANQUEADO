...
const CATEGORIAS = {
  ...
  frios: {
    ...
    itens: [
      ...
      { { id: "queijo-prato", nome: "Queijo Prato", preco: 1.26, porcao: "20g" } },
      ...
      { id: "bisnaga-catupiry", nome: "Catupiry", preco: 40.83, porcao: "5un 1,5kg" },
  ...
  embalagens: {
    ...
    itens: [
      ...
      { id: "bandeja-bh-102", nome: "Estojo 102", preco: 124.30, porcao: "cx c/100" },
      ...
      { { id: "saco-grecepell-1kg", nome: "Saco Gressepel 1kg", preco: 213.4, porcao: "1 mala" } },
      { { id: "saco-grecepell-2kg", nome: "Saco Grecepell 2kg", preco: 148.5, porcao: "500 unid." } },
      ...
      { id: "saco-lixo", nome: "Saco de Lixo", preco: 13.46, porcao: "un" },
            { id: "ketchup-heinz", nome: "Sachê Ketchup Heinz", preco: 20.89, porcao: "cx unidade" },
      { id: "mostarda-heinz", nome: "Sachê Mostarda Heinz", preco: 20.89, porcao: "cx unidade" },
      { id: "maionese-heinz", nome: "Sachê Maionese Heinz", preco: 20.89, porcao: "cx unidade" },
